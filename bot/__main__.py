...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("Repo", "https://github.com/Lucifer-Royal-Gaming/mirror-leech-telegram-bot")
    buttons.buildbutton("Report Group", "https://t.me/luciferultrongaming")
